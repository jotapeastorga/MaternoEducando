...
<head>
    <link rel="stylesheet" href="../CSS/StyleHorasAnterCli.css">
...
<div id="contenedor">
        ...
        <div id="menu">
            ...
            <?php } else {
                if ($rutSesionPaciente == 184896559 or $rutSesionPaciente == 176557865) {
                    ...
                    <div id="inicio">
                        <button type="button" name="btnInicio" class="btnMenu"
                        </button><a style="text-decoration:none" href=<?php echo $home ?>>Profesional </a></div>
                <?php } else {
                    ?>
                    <div id="inicio">
                        <button type="button" name="btnInicio" class="btnMenu"
                        </button><a style="text-decoration:none" href=<?php echo $home ?>>Paciente </a></div>
                    <?php
                }
            } ?>
            <div id="qS">
    ...
    <div id="contHorasCli">
        <div id="HorasCliente"><h1>Registro de citas asistidas</h1></div>
        <div class="hora"> <!--Hora-->
            <div class="fotoPerfil"></div>
            <div class="infoHora">Aquí deberia ir la informacion de la hora, por ejemplo indicaciones generales, nombre
                de la especialista, etc
            </div>
    ...
    <div id="GoBack">
        <button type="button" name="btnMenuCli" class="btnMenuCli"><a style="text-decoration:none"
                                                                      href="../html/sesionCli.php">Ir a mi menu</a>
        </button>
    </div>
