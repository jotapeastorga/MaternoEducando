...
try {
    ...
    $mail->Username   = 'astorga.pablo.juan@gmail.com';                     //SMTP username
    $mail->Password   = 'vhmlwnmnvwhgxxhj';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('astorga.pablo.juan@gmail.com', 'CODEPE');
    $mail->addAddress('astorga.pablo.juan@gmail.com', 'CODEPE');     //Add a recipient
