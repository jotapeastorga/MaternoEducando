...
<div id="contenedor">
    ...
    <div id="contHorasCli">
        ...
        <div class="hora"> <!--Hora-->
            ...
            <div class="infoHora">
                ...
                $resultados = mysqli_query(conectar(), "SELECT * FROM agendaprofesional,paciente WHERE rutPaciente = '$rutSesionPaciente' and rutPacienteCita = rutPaciente");
                ?>
                <table border=1>
                    <tr>
                        <th> Mes</th>
                    ...
                    while ($consulta = mysqli_fetch_array($resultados)) {
                        echo "<tr>";
                        ?>
                        <form action="../html/muestraSesionPaciente.php" method="post">
                            <input type="hidden" name="textoCitaElegida"
                                   value="<?php echo $consulta["resumenSesion"] ?>">
                            ...
                            <td><?php echo $consulta["rutPacienteCita"] ?>
                                <input type="hidden" name="rutCitaElegida"
                                       value=<?php echo $consulta["rutPacienteCita"] ?>>
                            </td>
                            <td><?php
                                ...
                                ?>
                                <input type="hidden" name="bloqueCitaElegida"
                                       value=<?php echo $consulta["idBloqueAgenda"] ?>>
                            </td>
                            <td><?php echo $consulta["nombrePaciente"] ?>
                                <input type="hidden" name="nombreCitaElegida"
                                       value=<?php echo $consulta["nombrePaciente"] ?>>
                            </td>
                            <td><?php echo $consulta["estadoCita"] ?>
                                <input type="hidden" name="estadoCitaElegida"
                                       value=<?php echo $consulta["estadoCita"] ?>>
                            </td>
                            <td>
    ...
    <div id="GoBack">
        <button type="button" name="btnMenuCli" class="btnMenuCli"><a style="text-decoration:none"
                                                                      href="../html/sesionCli.php">Volver a mis
                Sesiones</a></button>
    </div>
