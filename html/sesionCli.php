...
<div id="cont_formulario" class="textCenter"> <!--Formulario de registro-->
    <div id="formulario">
        <form id="registrarPaciente">
            ...
            <button class="btnSesion" type="submit"><a style="text-decoration:none" href="../html/prxHorCli.php">Mis
                    proximas citas</a></button>
            <br>
            <button class="btnSesion" type="submit"><a style="text-decoration:none" href="../html/HorasAnterCli.php">Historial
                    de sesiones</a></button>
        </form>
