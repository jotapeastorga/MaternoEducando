...
if  ($nombreActivo==null){
    ...
    if(mysqli_query(conectar(),"UPDATE agendaprofesional SET estadoProfesionalAgenda = 1,rutPacienteCita = '$rutPac',estadoCita='RESERVADO' WHERE rutProfesionalAgenda = '184896559' AND dia = '$diaReserva' AND mes = '$mesReserva' AND estadoProfesionalAgenda = 0 AND idBloqueAgenda  ='$bloqueEli'")){
