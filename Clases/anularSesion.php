...
if(mysqli_query(conectar(),"UPDATE agendaprofesional SET estadoCita ='ANULADO' WHERE rutProfesionalAgenda = '$rutPac' AND dia = '$diaCita' AND mes = '$mesCita' AND idBloqueAgenda  ='$bloqueCita'")){
